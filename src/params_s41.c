...
static inline void init_dynamically_allocated(void) {
  unsigned int* params_s41_h = malloc(ZKP_PARAMS_S41_H_ORDER * ZKP_PARAMS_S41_DOMAIN * sizeof(unsigned int));
  ...
  unsigned int* params_s41_f = malloc(ZKP_PARAMS_S41_ALPHA * ZKP_PARAMS_S41_DOMAIN * sizeof(unsigned int));
